...
```typescript
import { BotList } from '@/domain/catalog-bots-d001'; // client component
import { BotListServer } from '@/domain/catalog-bots-d001/index.server'; // server wrapper
import { BotDetails } from '@/domain/catalog-bots-d001'; // client component
import { BotDetailsServer } from '@/domain/catalog-bots-d001/index.server'; // server wrapper
import { BotPicker } from '@/domain/catalog-bots-d001'; // client component
import { BotPickerServer } from '@/domain/catalog-bots-d001/index.server'; // server wrapper
...
import {
  ...
  updateBot,
  deleteBot
} from '@/domain/catalog-bots-d001/index.server';
